...
export const initFilterData = (mosaicData, selectedFilters) => {
    console.log('initFilterData > selectedFilters: ', selectedFilters);
    console.log('initFilterData > AVAILABLE_FILTER_CONFIGURATIONS[selectedFilters]: ', AVAILABLE_FILTER_CONFIGURATIONS[selectedFilters]);

    mosaicData.activeFilters = AVAILABLE_FILTER_CONFIGURATIONS[selectedFilters].filters;
    console.log('initFilterData > mosaicData.activeFilters: ', mosaicData.activeFilters);
}

export const setUpCanvasEvents = (fabricCanvas, mosaicData, setMouseCoords, setZoom) => {
...
export const doTheMosaic = (fabricCanvas, mosaicData) => {
    setCanvasSize(fabricCanvas);
    loadFilesIntoCanvas(fabricCanvas, mosaicData);
    renderCanvas(fabricCanvas, mosaicData);
};

export const refreshTheMosaic = (mosaicData) => {
    loadFilesIntoCanvas(mosaicData.currentRef, mosaicData);
    renderCanvas(mosaicData.currentRef, mosaicData);
};
...
const applyFiltersToImg = (loadedImg, mosaicData) => {
    ...
    console.log('applyFiltersToImg > activeFilters: ', activeFilters);
...
const renderCanvas = (fabricCanvas) => {
    console.log('renderCanvas > fabricCanvas: ', fabricCanvas);
